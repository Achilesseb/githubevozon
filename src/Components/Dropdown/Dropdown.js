...
export function Dropdown() {
  ...
  return (
    <div className="p-2 bg-blue-200 rounded w-80 md:flex md:flex-col md:flex-wrap md:max-h-[50vh] md:w-[30vw] md:h-auto gap-3">
      {/*  USER CONTAINER  */}
      {usersPrimaryData
        ...
        .map((user) => (
          <Link
            ...
            to={`/${user.login}/info
            `}
            className="flex items-center gap-3 px-2 my-2 transition ease-in-out bg-gray-400 rounded md:my-0 md:p-2 hover:bg-gray-600 hover:cursor-pointer"
          >
            <div>
              <img className="rounded-full w-14 md:w-20" src={user.avatar} />
            </div>
